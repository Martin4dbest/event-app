...
class User(db.Model):
    ...
    """
    id = db.Column(db.String(36), primary_key=True, unique=True, nullable=False)  # Change to String(36)
...
class UserGroup(db.Model):
    ...
    """
    user_id = db.Column(db.String(36), db.ForeignKey('user.id'), primary_key=True)  # Change to String(36)
    group_id = db.Column(db.String(36), db.ForeignKey('group.id'), primary_key=True)  # Change to String(36)
...
class Event(db.Model):
    ...
    creator = db.Column(db.String(36), db.ForeignKey('user.id'))  # Change to String(36)
...
class GroupEvent(db.Model):
    ...
    Attributes:
        ...
        group_id (str): The foreign key to the Group model as a text-based UUID.
    """
    event_id = db.Column(db.String(36), db.ForeignKey('event.id'), primary_key=True)  # Change to String(36)
    group_id = db.Column(db.String(36), db.ForeignKey('group.id'), primary_key=True)  # Change to String(36)
...
class Comment(db.Model):
    ...
    user_id = db.Column(db.String(36), db.ForeignKey('user.id'))  # Change to String(36)
    event_id = db.Column(db.String(36), db.ForeignKey('event.id'))  # Change to String(36)
...
class Image(db.Model):
    ...
    """
    id = db.Column(db.String(36), primary_key=True, unique=True, nullable=False)  # Change to String(36)
    comment_id = db.Column(db.String(36), db.ForeignKey('comment.id'))  # Change to String(36)
